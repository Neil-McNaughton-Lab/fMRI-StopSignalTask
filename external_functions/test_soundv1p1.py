...
import copy
def TestSound(win2, defaultKeyboard2, expInfo2, 
              frameTolerance=0.001, endExpNow=False, nReps=100):
    '''
    ...
    '''
    win = copy.copy(win2)
    defaultKeyboard = copy.copy(defaultKeyboard2)
    expInfo = copy.copy(expInfo2)
